...
async function showUser(username: string) {
  ...
  function showTopFive() {
    const topFive = users.slice().sort((a, b) => b.public_repos - a.public_repos).slice(0, 5) // Obter os 5 primeiros
  // Sort modificar o array quando usado com o slice que criar uma copia , ele modificar a copia 
